...
unsafe extern "system" fn get_audio_parameters<I: AudioHandler>(
...
unsafe extern "system" fn on_audio_stream_packet<I: AudioHandler>(
...
// unsafe extern "system" fn on_audio_stream_started<I: AudioHandler>(
...
pub fn wrap<T: AudioHandler>(audio: T) -> *mut cef_audio_handler_t {
