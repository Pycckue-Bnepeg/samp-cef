...
extern "stdcall" {
    pub fn D3DXGetImageInfoFromFileA(
        pSrcFile: LPCSTR,
        pSrcInfo: *mut D3DXIMAGE_INFO,
    ) -> HRESULT;
}
extern "stdcall" {
    pub fn D3DXGetImageInfoFromFileW(
        pSrcFile: LPCWSTR,
        pSrcInfo: *mut D3DXIMAGE_INFO,
    ) -> HRESULT;
}
...
extern "stdcall" {
    ...
    pub fn D3DXLoadSurfaceFromFileA(
        pDestSurface: LPDIRECT3DSURFACE9,
...
extern "stdcall" {
    ...
    pub fn D3DXFilterTexture(
        pBaseTexture: LPDIRECT3DBASETEXTURE9,
...
extern "stdcall" {
    pub fn D3DXFillTexture(
        ...
        pFunction: LPD3DXFILL2D,
        pData: LPVOID,
    ) -> HRESULT;
}
extern "stdcall" {
    pub fn D3DXFillCubeTexture(
        pCubeTexture: LPDIRECT3DCUBETEXTURE9,
        pFunction: LPD3DXFILL3D,
        pData: LPVOID,
    ) -> HRESULT;
}
extern "stdcall" {
    pub fn D3DXFillVolumeTexture(
        pVolumeTexture: LPDIRECT3DVOLUMETEXTURE9,
        pFunction: LPD3DXFILL3D,
        pData: LPVOID,
    ) -> HRESULT;
}
